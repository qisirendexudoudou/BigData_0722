...
import com.atguigu.mr.sort.SortSumDriver;
import com.atguigu.mr.sort.SortSumFlowMapper;
import com.atguigu.mr.sort.SortSumFlowReducer;
...
public class OrderBeanDriver {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		// 定义输入路径
		Path input=new Path("E:\\mrinput\\groupcomparator");
		Path output=new Path("E:\\mroutput\\groupcomparator");
		
		
		Configuration conf = new Configuration();
		
		// 分组比较器
		conf.set("mapreduce.job.output.group.comparator.class", "com.atguigu.mr.groupingcomparator.OrderIdComparator");
