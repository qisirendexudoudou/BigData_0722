...
import com.atguigu.mr.readsequencefile.WordCountMapper;
import com.atguigu.mr.readsequencefile.WordCountReducer;
...
public class WordCountDriver {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		Path output=new Path("E:\\mroutput\\readsequencefile");
		

		Configuration conf= new Configuration();
		
		//设置使用oCombineTextInputFormat
		conf.set("mapreduce.job.inputformat.class", "org.apache.hadoop.mapreduce.lib.input.SequenceFileInputFormat");
