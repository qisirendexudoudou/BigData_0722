...
public class ConsumerSave {
    ...
    private static final String OFFSET_PATH = "G:\\luogaolong\\offset";
    ...
    public static void main(String[] args) {
        ...
        //订阅到一个话题
        consumer.subscribe(Collections.singleton("frist"), new ConsumerRebalanceListener() {
        ...
        while (true) {
            ...
            TopicPartition first = new TopicPartition("frist", 0);
